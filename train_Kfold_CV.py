...
import model.loss_pw as module_loss
...
def weights_init_normal(m):
    if type(m) == nn.Conv2d:
        torch.nn.init.normal_(m.weight.data, 0.0, 0.5)
...
def main(config, fold_id):
    ...
    data_loader, valid_data_loader,label_scale = data_generator_np(args2.np_data_dir,batch_size)
